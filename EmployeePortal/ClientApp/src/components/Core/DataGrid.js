...
//import IsNull, { objectsEqual } from '../common/Common';
...
//            !objectsEqual(this.props.RowsData, nextProps.RowsData) ||
...
//        if (!objectsEqual(this.props.RowsData, prevProps.RowsData)) {
//            this.dataRecieved = this.state.rowsData
//        }
//        if (!objectsEqual(this.props.RowsData, prevProps.RowsData) ||
